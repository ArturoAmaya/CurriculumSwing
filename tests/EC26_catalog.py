...
(chosen_courses_min, new_curr_min) = cs.min_complexity(template, [(1, list) for list in electives.values()], catalog)

(chosen_courses_max, new_curr_max) = cs.max_complexity(template, [(1, list) for list in electives.values()], catalog)

#(a,b) = cs.dummy_max(template, [(1, list) for list in electives.values()], catalog)
print("max complexity: ",  new_curr_max.metrics["complexity"])
print(chosen_courses_max)

print("min complexity: ", new_curr_min.metrics["complexity"])
print(chosen_courses_min)
